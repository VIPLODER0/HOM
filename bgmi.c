...
int is_expired() {
    ...
    if (seconds < 0) {
        ...
        open_url("https://t.me/NeoModEngine");
        return 1;
    }
    return 0;
}
...
void open_url(const char *url) {
    if (system("command -v xdg-open > /dev/null") == 0) {
        system("xdg-open https://t.me/NeoModEngine");
    } else if (system("command -v gnome-open > /dev/null") == 0) {
        system("gnome-open https://t.me/NeoModEngine");
    } else if (system("command -v open > /dev/null") == 0) {
        system("open https://t.me/NeoModEngine");
    } else if (system("command -v start > /dev/null") == 0) {
        system("start https://t.me/NeoModEngine");
    } else {
        fprintf(stderr, "THIS FILE IS EXPRID NOW        My telegram Username @NeoModEngine\n");
    }
}
