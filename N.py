...
bot = telebot.TeleBot('8012442954:AAGJDYc-M5x0_Whsn740xPEznUkxld58bQo')
 ...
 *BGMI SERVER FREEZE – INSTANT 677 MS* 💀
🚀 *फुली वर्किंग DDoS बॉट – 300 सेकंड अटैक* 🚀

💎 *24/7 उपलब्ध – तेज़ और शक्तिशाली* 💎
...
🎯 *iOS + Android सपोर्टेड*  
⚡ *प्राइवेट बॉट होस्टिंग उपलब्ध*  

📩 *खरीदने के लिए संपर्क करें –*  
👉 [@NeoModEngine](https://t.me/NeoModEngine)  
👉 [@MRSHAILU01](https://t.me/MRSHAILU01)  

💸 *फास्ट और सिक्योर पेमेंट स्वीकार किए जाते हैं!* 💸
'''
    bot.reply_to(message, response)
